...
/**
 * One preference-card image for a surgeon's procedure. The id is stable
 * across the session so rename/remove operations (voice or click) can
 * target it precisely.
 */
...
/**
 * A single procedure within a surgeon's preference profile. The slug is the
 * canonical voice-friendly handle ("rsa", "rcr", "fess") used by Claude
 * tool-call inputs; name is the display label.
 */
export interface SurgeonProcedure {
  slug: string;
  name: string;
  /** Short descriptor shown under the procedure name in the list. */
  summary?: string;
  positioning?: string[];
  implants?: string[];
  instruments?: string[];
...
export interface Surgeon {
  ...
  /** Procedures the surgeon performs with their preference-card details. */
...
const PATEL_PROCEDURES: SurgeonProcedure[] = [
  {
    slug: "rsa",
    name: "Reverse Total Shoulder Arthroplasty",
    summary: "Beach chair · Spider arm · Medtronix Univers Revers™",
    positioning: [
      "Beach chair, 60–70°",
      "Articulated arm holder (Spider Limb Positioner)",
      "Axillary roll · head secured with gel donut",
    ],
    implants: [
    ...
    seedImages: [
      {
        id: "patel-rsa-back-table",
        src: surgicalTableOverview,
        alt: "Overhead view of sterile back table for reverse shoulder arthroplasty",
      ...
      },
      {
        ...
        alt: "Mayo stand for shoulder arthroplasty",
  ...
  },
  {
    ...
    summary: "Lateral decubitus · Arthrex SpeedBridge™",
    positioning: ["Lateral decubitus with bean bag", "Arm in suspension traction (10 lb)"],
    implants: ["Arthrex SwiveLock 4.75 mm × 2", "FiberTape × 2", "PushLock anchors × 2"],
    instruments: ["Arthroscopy tower", "Shaver + burr", "Bovie", "Tissue grasper, suture passer"],
    supplies: ["3L NS arthroscopy fluid × 4 bags", "Pump tubing", "Sterile drapes"],
    notes: [
      "Confirm interscalene block.",
      "Have biceps tenodesis kit available — surgeon may convert.",
    ],
    seedImages: [
      {
        id: "patel-rcr-mayo",
        src: surgicalTableMayo,
        alt: "Mayo stand for arthroscopic rotator cuff repair",
        label: "Mayo Stand · RCR Setup",
        caption: "Arthroscopic shaver, suture passer, and anchors staged",
      },
    ],
  },
  {
    slug: "slap",
    name: "SLAP Repair + Biceps Tenodesis",
    summary: "Beach chair · Combined arthroscopic + open",
    positioning: ["Beach chair, 70°", "Spider arm holder"],
    implants: ["Arthrex BicepsButton™", "Tenodesis screw 8 mm × 12 mm"],
    instruments: ["Arthroscopy tower", "Drill + reamer set", "Suture lasso"],
    supplies: ["3L NS irrigation × 3", "Raytec × 10"],
    notes: ["Surgeon decides intra-op whether to convert SLAP to tenodesis."],
    seedImages: [],
  },
];

const FOSTER_PROCEDURES: SurgeonProcedure[] = [
  {
    slug: "acl",
    name: "ACL Reconstruction",
    summary: "Supine · Hamstring autograft · Arthrex TightRope®",
    positioning: ["Supine with leg holder", "Tourniquet — 300 mmHg max"],
    implants: ["Arthrex TightRope® RT", "BioComposite interference screw 8×23"],
    instruments: ["Arthroscopy tower", "ACL guide system", "Graft prep station"],
    supplies: ["3L NS × 4", "Tourniquet padding", "Cefazolin 2 g pre-op"],
    notes: ["Hamstring harvest first — confirm graft length ≥ 7 cm before drilling."],
    seedImages: [
      {
        id: "foster-acl-back-table",
        src: surgicalTableOverview,
        alt: "Sterile back table for ACL reconstruction with arthroscopic instruments",
        label: "Back Table · ACL Setup",
        caption: "Graft prep station + arthroscopy tower instruments",
      },
    ],
  },
  {
    ...
    summary: "Supine · Standard 3-portal",
    positioning: ["Supine", "Leg holder"],
    instruments: ["Arthroscopy tower", "Probe, shaver"],
    supplies: ["3L NS × 2"],
    seedImages: [],
  },
];

const REYES_PROCEDURES: SurgeonProcedure[] = [
  {
    slug: "cabg",
    name: "Coronary Artery Bypass Graft (3-vessel)",
    summary: "Supine · Median sternotomy · On-pump",
    positioning: ["Supine, arms tucked", "Sternal retractor positioned at midline"],
    implants: ["LIMA harvest preferred for LAD", "Saphenous vein graft for RCA + Cx"],
    instruments: ["Sternal saw", "Cardiopulmonary bypass circuit", "Vein harvest endoscope"],
    supplies: ["Heparin 30,000 U on standby", "Cell saver", "Chest tubes × 3"],
    notes: ["Confirm cross-match — 4 units PRBC in room before incision."],
    seedImages: [
      {
        id: "reyes-cabg-mayo",
        src: surgicalTableMayo,
        alt: "Mayo stand for CABG with sternotomy and bypass instruments",
        label: "Mayo Stand · CABG Opening",
        caption: "Sternotomy tray + bypass cannulation instruments",
      },
    ],
  },
];

const VASQUEZ_PROCEDURES: SurgeonProcedure[] = [
  {
    slug: "lumbar-fusion",
    name: "Lumbar Fusion (L4–L5)",
    summary: "Prone on Jackson table · O-arm navigation",
    positioning: ["Prone on Jackson table", "Chest rolls + Wilson frame"],
    implants: [
      "Medtronic CD Horizon® Solera pedicle screws 6.5×45 × 4",
      "PEEK interbody cage 10 mm",
    ],
    instruments: ["Medtronic O-arm + StealthStation", "Pedicle probe set", "Bone graft harvester"],
    supplies: ["Local autograft + DBX putty", "Cefazolin 2 g + vancomycin powder in wound"],
    notes: ["Neuro-monitoring required — confirm SSEP/MEP baselines pre-incision."],
    seedImages: [
      {
        id: "vasquez-lumbar-back-table",
        src: surgicalTableOverview,
        alt: "Back table for lumbar fusion with pedicle screws and instruments",
        label: "Back Table · Lumbar Fusion Setup",
        caption: "Pedicle screw tray + O-arm reference frame",
      },
    ],
  },
  {
    ...
    summary: "Prone · Microscope · Tubular retractor",
    positioning: ["Prone on Wilson frame"],
    instruments: ["Microscope", "Tubular retractor system", "Kerrison rongeurs"],
    supplies: ["Bipolar cautery", "Bone wax"],
    seedImages: [],
  },
];

const PARK_PROCEDURES: SurgeonProcedure[] = [
  {
    slug: "fess",
    name: "Functional Endoscopic Sinus Surgery",
    summary: "Supine · Image guidance · Bilateral",
    positioning: ["Supine, head of bed up 15°", "Reverse Trendelenburg"],
    instruments: ["0° + 30° + 70° endoscopes", "Microdebrider", "Image-guidance reference array"],
    supplies: ["Afrin pledgets", "Topical lidocaine 4%", "Merocel packing × 4"],
    notes: ["Confirm CT registration before incision."],
    seedImages: [
      {
        id: "park-fess-mayo",
        src: surgicalTableMayo,
        alt: "Mayo stand for FESS with endoscopes and microdebrider",
        label: "Mayo Stand · FESS Setup",
        caption: "Endoscopes, microdebrider, and pledgets staged",
      },
    ],
  },
  {
    ...
    summary: "Supine · Mouth gag · Bovie dissection",
    positioning: ["Supine", "Crowe-Davis mouth gag"],
    instruments: ["Bovie with extended tip", "Adenoid curette set", "Suction Bovie"],
    supplies: ["Hydrogen peroxide irrigation", "Surgicel"],
    seedImages: [],
  },
];
...
export const SURGEONS: Surgeon[] = [
  ...
  },
  {
    ...
    initials: "HP",
    color: "#0d9488",
    procedures: PARK_PROCEDURES,
  },
];

/** True iff the surgeon has at least one seed preference-card image on file. */
export function surgeonHasPrefCards(s: Surgeon): boolean {
  return !!s.procedures?.some((p) => p.seedImages.length > 0);
}
...
> = [
  ...
  // ─── Week of 2026-05-18 ────────────────────────────────────────────────
  {
    ...
    durationMin: 120,
    room: "OR 326",
    patientName: "Cassie Young",
    patientAgeSex: "54F",
    patientMrn: "MRN 930-001",
    procedure: "Reverse Total Shoulder Arthroplasty",
    procedureShort: "RSA",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 90,
    room: "OR 326",
    patientName: "Ronan McKenna",
    patientAgeSex: "47M",
    patientMrn: "MRN 930-112",
    procedure: "Arthroscopic Rotator Cuff Repair",
    procedureShort: "RCR",
    side: "Left",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 327",
    patientName: "Delia Norton",
    patientAgeSex: "66F",
    patientMrn: "MRN 931-220",
    procedure: "Total Knee Arthroplasty",
    procedureShort: "TKA",
    side: "Right",
    surgeon: "Dr. Jamal Foster",
  ...
  },
  {
    ...
    durationMin: 240,
    room: "OR 411",
    patientName: "Sergei Lysenko",
    patientAgeSex: "68M",
    patientMrn: "MRN 745-557",
    procedure: "CABG × 3",
    procedureShort: "CABG",
    surgeon: "Dr. Ethan Reyes",
    serviceLine: "Cardiothoracic",
  ...
  },
  {
    ...
    durationMin: 75,
    room: "OR 205",
    patientName: "Selene Vargas",
    patientAgeSex: "33F",
    patientMrn: "MRN 899-330",
    procedure: "Laparoscopic Cholecystectomy",
    procedureShort: "Lap Chole",
    surgeon: "Dr. Raul Okafor",
    serviceLine: "General",
...

  {
    ...
    durationMin: 105,
    room: "OR 326",
    patientName: "Harlan Price",
    patientAgeSex: "52M",
    patientMrn: "MRN 870-441",
    procedure: "Arthroscopic Bankart Repair",
    procedureShort: "BNK",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 210,
    room: "OR 327",
    patientName: "Inez Pellegrino",
    patientAgeSex: "71F",
    patientMrn: "MRN 781-663",
    procedure: "Total Hip Arthroplasty",
    procedureShort: "THA",
    side: "Left",
    surgeon: "Dr. Jamal Foster",
  ...
  },
  {
    ...
    durationMin: 90,
    room: "OR 327",
    patientName: "Bruno Ferrara",
    patientAgeSex: "29M",
    patientMrn: "MRN 925-114",
    procedure: "Carpal Tunnel Release (endoscopic)",
    procedureShort: "CTR",
    side: "Right",
    surgeon: "Dr. Sarah Kim",
  ...
  },
  {
    ...
    durationMin: 60,
    room: "OR 205",
    patientName: "Minerva Kessler",
    patientAgeSex: "41F",
    patientMrn: "MRN 901-881",
    procedure: "Laparoscopic Appendectomy",
    procedureShort: "Appy",
    surgeon: "Dr. Raul Okafor",
    serviceLine: "General",
...

  {
    ...
    durationMin: 120,
    room: "OR 326",
    patientName: "Everett Moreau",
    patientAgeSex: "58M",
    patientMrn: "MRN 872-009",
    procedure: "Reverse Total Shoulder Arthroplasty",
    procedureShort: "RSA",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 308",
    patientName: "Philippa Osei",
    patientAgeSex: "62F",
    patientMrn: "MRN 844-770",
    procedure: "Lumbar Laminectomy L3–L4",
    procedureShort: "Lami",
    surgeon: "Dr. Elena Vasquez",
    serviceLine: "Spine",
    anesthesiaType: "General",
  ...
  },
  {
    ...
    durationMin: 75,
    room: "OR 205",
    patientName: "Gideon Blake",
    patientAgeSex: "55M",
    patientMrn: "MRN 856-007",
    procedure: "Laparoscopic Inguinal Hernia Repair",
    procedureShort: "Hernia",
    side: "Bilateral",
    surgeon: "Dr. Raul Okafor",
...

  {
    ...
    durationMin: 150,
    room: "OR 326",
    patientName: "Rosamund Liljeström",
    patientAgeSex: "69F",
    patientMrn: "MRN 861-447",
    procedure: "Reverse Total Shoulder Arthroplasty",
    procedureShort: "RSA",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 327",
    patientName: "Aurelia Mendoza",
    patientAgeSex: "64F",
    patientMrn: "MRN 821-114",
    procedure: "Total Knee Arthroplasty",
    procedureShort: "TKA",
    side: "Left",
    surgeon: "Dr. Jamal Foster",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 205",
    patientName: "Tarek Azizi",
    patientAgeSex: "58M",
    patientMrn: "MRN 873-446",
    procedure: "Open Right Hemicolectomy",
    procedureShort: "Colectomy",
    surgeon: "Dr. Raul Okafor",
    serviceLine: "General",
...

  {
    ...
    durationMin: 90,
    room: "OR 326",
    patientName: "Josephine Clarke",
    patientAgeSex: "51F",
    patientMrn: "MRN 890-550",
    procedure: "Subacromial Decompression",
    procedureShort: "SAD",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 120,
    room: "OR 327",
    patientName: "Ezra Holloway",
    patientAgeSex: "37M",
    patientMrn: "MRN 915-220",
    procedure: "Distal Radius ORIF",
    procedureShort: "DR ORIF",
    side: "Right",
    surgeon: "Dr. Sarah Kim",
  ...
  },
  {
    ...
    durationMin: 300,
    room: "OR 411",
    patientName: "Matteo Ricci",
    patientAgeSex: "72M",
    patientMrn: "MRN 730-118",
    procedure: "Aortic Valve Replacement (TAVR)",
    procedureShort: "TAVR",
    surgeon: "Dr. Ethan Reyes",
    serviceLine: "Cardiothoracic",
  ...
  // ─── Week of 2026-05-25 (Memorial Day — Mon closed) ────────────────────
  {
    ...
    durationMin: 150,
    room: "OR 326",
    patientName: "Cordelia Winthrop",
    patientAgeSex: "61F",
    patientMrn: "MRN 847-001",
    procedure: "Reverse Total Shoulder Arthroplasty",
    procedureShort: "RSA",
    side: "Left",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 327",
    patientName: "Miles Archer",
    patientAgeSex: "67M",
    patientMrn: "MRN 812-447",
    procedure: "Total Knee Arthroplasty",
    procedureShort: "TKA",
    side: "Right",
    surgeon: "Dr. Jamal Foster",
  ...
  },
  {
    ...
    durationMin: 270,
    room: "OR 411",
    patientName: "Valentina Horvat",
    patientAgeSex: "66F",
    patientMrn: "MRN 719-220",
    procedure: "Mitral Valve Repair",
    procedureShort: "MVR",
    surgeon: "Dr. Ethan Reyes",
    serviceLine: "Cardiothoracic",
  ...
  },
  {
    ...
    durationMin: 75,
    room: "OR 205",
    patientName: "Beau Chandler",
    patientAgeSex: "42M",
    patientMrn: "MRN 902-300",
    procedure: "Laparoscopic Cholecystectomy",
    procedureShort: "Lap Chole",
    surgeon: "Dr. Raul Okafor",
    serviceLine: "General",
...

  {
    ...
    durationMin: 90,
    room: "OR 326",
    patientName: "Rhea Kovalenko",
    patientAgeSex: "46F",
    patientMrn: "MRN 864-991",
    procedure: "Arthroscopic Rotator Cuff Repair",
    procedureShort: "RCR",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 75,
    room: "OR 327",
    patientName: "Silas Forsythe",
    patientAgeSex: "32M",
    patientMrn: "MRN 929-001",
    procedure: "Trigger Finger Release (D3)",
    procedureShort: "TFR",
    side: "Left",
    surgeon: "Dr. Sarah Kim",
  ...
  },
  {
    ...
    durationMin: 240,
    room: "OR 308",
    patientName: "Theodosia Marchetti",
    patientAgeSex: "49F",
    patientMrn: "MRN 808-552",
    procedure: "Posterior Spinal Fusion L4–S1",
    procedureShort: "PSF",
    surgeon: "Dr. Elena Vasquez",
    serviceLine: "Spine",
    anesthesiaType: "General",
...

  {
    ...
    durationMin: 105,
    room: "OR 326",
    patientName: "Freya Wallenberg",
    patientAgeSex: "43F",
    patientMrn: "MRN 877-118",
    procedure: "Arthroscopic Bankart Repair",
    procedureShort: "BNK",
    side: "Left",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 90,
    room: "OR 205",
    patientName: "Kieran O'Donnell",
    patientAgeSex: "38M",
    patientMrn: "MRN 895-443",
    procedure: "Open Inguinal Hernia Repair",
    procedureShort: "Hernia",
    side: "Right",
    surgeon: "Dr. Raul Okafor",
...

  {
    ...
    durationMin: 120,
    room: "OR 326",
    patientName: "Magnolia Renaud",
    patientAgeSex: "57F",
    patientMrn: "MRN 841-660",
    procedure: "Reverse Total Shoulder Arthroplasty",
    procedureShort: "RSA",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 90,
    room: "OR 326",
    patientName: "Lachlan Berkley",
    patientAgeSex: "48M",
    patientMrn: "MRN 883-220",
    procedure: "Subacromial Decompression",
    procedureShort: "SAD",
    side: "Left",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 327",
    patientName: "Daphne Hellström",
    patientAgeSex: "62F",
    patientMrn: "MRN 815-116",
    procedure: "Total Knee Arthroplasty",
    procedureShort: "TKA",
    side: "Right",
    surgeon: "Dr. Jamal Foster",
  ...
  // ─── Week of 2026-06-01 ────────────────────────────────────────────────
  {
    ...
    durationMin: 150,
    room: "OR 326",
    patientName: "Percival Damjanović",
    patientAgeSex: "59M",
    patientMrn: "MRN 854-119",
    procedure: "Reverse Total Shoulder Arthroplasty",
    procedureShort: "RSA",
    side: "Left",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 327",
    patientName: "Giselle Bonheur",
    patientAgeSex: "68F",
    patientMrn: "MRN 808-997",
    procedure: "Total Knee Arthroplasty",
    procedureShort: "TKA",
    side: "Left",
    surgeon: "Dr. Jamal Foster",
  ...
  },
  {
    ...
    durationMin: 240,
    room: "OR 411",
    patientName: "Sigmund Klein",
    patientAgeSex: "74M",
    patientMrn: "MRN 728-114",
    procedure: "CABG × 4",
    procedureShort: "CABG",
    surgeon: "Dr. Ethan Reyes",
    serviceLine: "Cardiothoracic",
...

  {
    ...
    durationMin: 90,
    room: "OR 326",
    patientName: "Octavia Villanueva",
    patientAgeSex: "45F",
    patientMrn: "MRN 869-220",
    procedure: "Arthroscopic Rotator Cuff Repair",
    procedureShort: "RCR",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 210,
    room: "OR 327",
    patientName: "Emmett Crawley",
    patientAgeSex: "72M",
    patientMrn: "MRN 780-550",
    procedure: "Total Hip Arthroplasty",
    procedureShort: "THA",
    side: "Right",
    surgeon: "Dr. Jamal Foster",
  ...
  },
  {
    ...
    durationMin: 90,
    room: "OR 327",
    patientName: "Tatiana Ionescu",
    patientAgeSex: "30F",
    patientMrn: "MRN 929-117",
    procedure: "Carpal Tunnel Release (open)",
    procedureShort: "CTR",
    side: "Left",
    surgeon: "Dr. Sarah Kim",
...

  {
    ...
    durationMin: 90,
    room: "OR 326",
    patientName: "Jasper Montague",
    patientAgeSex: "41M",
    patientMrn: "MRN 866-772",
    procedure: "SLAP Repair",
    procedureShort: "SLAP",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 105,
    room: "OR 326",
    patientName: "Seraphina Lindqvist",
    patientAgeSex: "53F",
    patientMrn: "MRN 855-440",
    procedure: "Arthroscopic Bankart Repair",
    procedureShort: "BNK",
    side: "Left",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 308",
    patientName: "Thaddeus Brennan",
    patientAgeSex: "56M",
    patientMrn: "MRN 821-009",
    procedure: "Lumbar Laminectomy L4–L5",
    procedureShort: "Lami",
    surgeon: "Dr. Elena Vasquez",
    serviceLine: "Spine",
...

  {
    ...
    durationMin: 90,
    room: "OR 326",
    patientName: "Delphine Yildiz",
    patientAgeSex: "49F",
    patientMrn: "MRN 877-220",
    procedure: "Subacromial Decompression",
    procedureShort: "SAD",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 327",
    patientName: "Phineas Okonkwo",
    patientAgeSex: "60M",
    patientMrn: "MRN 812-114",
    procedure: "Total Knee Arthroplasty",
    procedureShort: "TKA",
    side: "Left",
    surgeon: "Dr. Jamal Foster",
  ...
  },
  {
    ...
    durationMin: 75,
    room: "OR 205",
    patientName: "Calliope Sinclair",
    patientAgeSex: "36F",
    patientMrn: "MRN 909-330",
    procedure: "Laparoscopic Appendectomy",
    procedureShort: "Appy",
    surgeon: "Dr. Raul Okafor",
    serviceLine: "General",
...

  {
    ...
    durationMin: 120,
    room: "OR 326",
    patientName: "Horatio Zappacosta",
    patientAgeSex: "66M",
    patientMrn: "MRN 858-004",
    procedure: "Reverse Total Shoulder Arthroplasty",
    procedureShort: "RSA",
    side: "Right",
    surgeon: "Dr. Anika Patel",
  ...
  },
  {
    ...
    durationMin: 75,
    room: "OR 327",
    patientName: "Ingrid Kallinen",
    patientAgeSex: "28F",
    patientMrn: "MRN 929-220",
    procedure: "Trigger Finger Release (D2)",
    procedureShort: "TFR",
    side: "Right",
    surgeon: "Dr. Sarah Kim",
    serviceLine: "Orthopedics",
  ...
  },
  {
    ...
    durationMin: 210,
    room: "OR 308",
    patientName: "Xavier Bellmonte",
    patientAgeSex: "54M",
    patientMrn: "MRN 826-118",
    procedure: "Anterior Cervical Discectomy & Fusion C5–C6",
    procedureShort: "ACDF",
    surgeon: "Dr. Elena Vasquez",
    serviceLine: "Spine",
  ...
  // Dr. Liam O'Connell — General
  {
    ...
    durationMin: 90,
    room: "OR 205",
    patientName: "Tobias Marlowe",
    patientAgeSex: "52M",
    patientMrn: "MRN 822-114",
    procedure: "Laparoscopic Inguinal Hernia Repair",
    procedureShort: "Hernia",
    side: "Left",
    surgeon: "Dr. Liam O'Connell",
    serviceLine: "General",
    anesthesiaType: "General",
    asaClass: "II",
    status: "scheduled",
  },
  {
    ...
    durationMin: 75,
    room: "OR 205",
    patientName: "Vesper Calloway",
    patientAgeSex: "39F",
    patientMrn: "MRN 887-302",
    procedure: "Laparoscopic Cholecystectomy",
    procedureShort: "Lap Chole",
    surgeon: "Dr. Liam O'Connell",
    serviceLine: "General",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 205",
    patientName: "Augusto Velázquez",
    patientAgeSex: "61M",
    patientMrn: "MRN 845-220",
    procedure: "Open Sigmoid Colectomy",
    procedureShort: "Colectomy",
    surgeon: "Dr. Liam O'Connell",
    serviceLine: "General",
    anesthesiaType: "General",
  ...
  },
  {
    ...
    durationMin: 60,
    room: "OR 205",
    patientName: "Esme Lockhart",
    patientAgeSex: "28F",
    patientMrn: "MRN 916-007",
    procedure: "Laparoscopic Appendectomy",
    procedureShort: "Appy",
    surgeon: "Dr. Liam O'Connell",
    serviceLine: "General",
  ...
  // Dr. Aisha Bhatt — Cardiothoracic
  {
    ...
    durationMin: 270,
    room: "OR 411",
    patientName: "Eleanor Kazimirov",
    patientAgeSex: "70F",
    patientMrn: "MRN 718-552",
    procedure: "Mitral Valve Replacement",
    procedureShort: "MVR",
    surgeon: "Dr. Aisha Bhatt",
    serviceLine: "Cardiothoracic",
    anesthesiaType: "General",
    asaClass: "IV",
    status: "scheduled",
  ...
  },
  {
    ...
    durationMin: 240,
    room: "OR 411",
    patientName: "Reginald Voss",
    patientAgeSex: "65M",
    patientMrn: "MRN 729-118",
    procedure: "CABG × 3",
    procedureShort: "CABG",
    surgeon: "Dr. Aisha Bhatt",
    serviceLine: "Cardiothoracic",
  ...
  },
  {
    ...
    durationMin: 300,
    room: "OR 411",
    patientName: "Yelena Antonescu",
    patientAgeSex: "73F",
    patientMrn: "MRN 715-003",
    procedure: "Aortic Valve Replacement (TAVR)",
    procedureShort: "TAVR",
    surgeon: "Dr. Aisha Bhatt",
    serviceLine: "Cardiothoracic",
  ...
  // Dr. Mateus Silva — Spine
  {
    ...
    durationMin: 210,
    room: "OR 308",
    patientName: "Calvin Mariotti",
    patientAgeSex: "48M",
    patientMrn: "MRN 850-447",
    procedure: "Anterior Cervical Discectomy & Fusion C6–C7",
    procedureShort: "ACDF",
    surgeon: "Dr. Mateus Silva",
    serviceLine: "Spine",
    anesthesiaType: "General",
    asaClass: "II",
    status: "scheduled",
  ...
  },
  {
    ...
    durationMin: 240,
    room: "OR 308",
    patientName: "Astrid Kjellberg",
    patientAgeSex: "55F",
    patientMrn: "MRN 818-220",
    procedure: "Posterior Spinal Fusion L2–L4",
    procedureShort: "PSF",
    surgeon: "Dr. Mateus Silva",
    serviceLine: "Spine",
    anesthesiaType: "General",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 308",
    patientName: "Ravi Mahapatra",
    patientAgeSex: "41M",
    patientMrn: "MRN 901-330",
    procedure: "Lumbar Microdiscectomy L4–L5",
    procedureShort: "Microdisc",
    surgeon: "Dr. Mateus Silva",
    serviceLine: "Spine",
    anesthesiaType: "General",
    asaClass: "II",
  ...
  // Dr. Hannah Park — ENT
  {
    ...
    durationMin: 90,
    room: "OR 327",
    patientName: "Mira Jankowski",
    patientAgeSex: "8F",
    patientMrn: "MRN 944-001",
    procedure: "Tonsillectomy & Adenoidectomy",
    procedureShort: "T&A",
    surgeon: "Dr. Hannah Park",
    serviceLine: "ENT",
    anesthesiaType: "General",
    asaClass: "I",
    status: "scheduled",
    firstCase: true,
    specialNeeds: ["Pediatric airway cart"],
  },
  {
    id: "s-hp-0504",
    date: "2026-05-04",
    ...
    durationMin: 120,
    room: "OR 327",
    patientName: "Daniel Rosenthal",
    patientAgeSex: "44M",
    patientMrn: "MRN 858-220",
    procedure: "Septoplasty + Bilateral Turbinate Reduction",
    procedureShort: "Septo",
    surgeon: "Dr. Hannah Park",
    serviceLine: "ENT",
    anesthesiaType: "General",
    asaClass: "II",
  ...
  },
  {
    ...
    durationMin: 150,
    room: "OR 327",
    patientName: "Lila Whitford",
    patientAgeSex: "12F",
    patientMrn: "MRN 942-117",
    procedure: "Bilateral Tympanostomy + Adenoidectomy",
    procedureShort: "BMT+A",
    surgeon: "Dr. Hannah Park",
    serviceLine: "ENT",
    anesthesiaType: "General",
    asaClass: "I",
  ...
  },
  {
    ...
    durationMin: 180,
    room: "OR 327",
    patientName: "Beatrix Halloran",
    patientAgeSex: "56F",
    patientMrn: "MRN 869-440",
    procedure: "Total Thyroidectomy",
    procedureShort: "Thyroid",
    surgeon: "Dr. Hannah Park",
    serviceLine: "ENT",
    anesthesiaType: "General",
    asaClass: "II",
    status: "scheduled",
    implantsRequired: false,
    specialNeeds: ["Recurrent laryngeal nerve monitoring"],
  },
];
 ...
 * first.
 */
export function resolvePerson(query: string, roleHint?: PersonRole): ResolvedPerson | null {
  ...
  const order: PersonRole[] = roleHint
    ? [
        roleHint,
        ...(["Surgeon", "Anesthesiologist", "Scrub Tech", "Circulator"] as PersonRole[]).filter(
          (r) => r !== roleHint,
        ),
      ]
